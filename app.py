...
class App(tk.Tk):
    ...
    def _himiya(self, f):
        ...
        finish = [
            ...
            (('Ел. монтаж','em',
              ['без','бошура/покана','етикети/визитки','корици','листовки/стикери',
               'минимално','плакат','страниране','флаери'],'без','electric_montage'),
             ('Пакетиране','counting',['да','<1000','не'],'да','counting')),
            
            (('Разделители','sep_mat',['без','вестник','картон'],'без','separators'),
             ('Операции, друго','other',None,'','other')),
