    ...
    def calculate_himiya(self):
        try:
            ...
            inp=HimiyaInputs(
                ...
                transport=self._hvar('transport').get(), transport_km=n('km',15), fuel_price=float(str(self.vars.get('price_fuel').get() if 'price_fuel' in self.vars else '1.15').replace(',','.')), surcharge_pct=n('surcharge',40), useful_grip=self._hvar('grip').get())
            forced_reps=None
